...
function App() {
  const { tasks, activeTask, contextSwitches, startTask, stopTask } = useTasks();
      ...
      <main className="flex-1 container py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">Monitor your context switching costs.</p>
          </div>
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          ...
          <TabsContent value="overview">
            <Overview tasks={tasks} switches={contextSwitches} activeTask={activeTask} />
          </TabsContent>
